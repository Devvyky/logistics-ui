...
const EditProduct = ({ setModalVisible }: ModalProps) => {
  ...
  const mutation = useMutation({
    ...
    mutationFn: (formValues: EditProductProps) => appServices.editPackSize('10', formValues),
  ...
  return (
    <div className='fixed h-full w-full top-0 left-0 bg-black bg-opacity-80 z-50'>
      <div className='px-8 pt-6 relative pb-8 rounded-md max-w-lg mx-auto mt-24 bg-neutral-100 shadow-md'>
        <h2 className='font-bold text-2xl text-center pb-6'>Edit Product</h2>
